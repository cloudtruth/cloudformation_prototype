...
require_relative 'cloudtruth/ssm_substitution_macro'
...
CT_KEY_TEMPLATE = ENV["CT_KEY_TEMPLATE"] || "/%{key}"

def cloudtruth_cf_macro_sync(event:, context:)
  begin
    ...
    key_template = params["KeyTemplate"] || templateParams["KeyTemplate"] || CT_KEY_TEMPLATE
    sm = CloudTruth::SSMSubstitutionMacro.new(api_key: CT_API_KEY, environment: env, param_filter: param_filter, key_template: key_template)
