...
require_relative 'aws_cloudformation_helper/event'
require_relative 'aws_cloudformation_helper/logger'
require_relative 'aws_cloudformation_helper/response'
require_relative 'aws_cloudformation_helper/version'
